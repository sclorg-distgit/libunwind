...
#for orig in $RPM_BUILD_ROOT%{_libdir}/pkgconfig/* ; do
#    sed -i -e 's/Name: libunwind/Name: %{?scl_prefix}libunwind/g' $orig
#    new="`dirname $orig`/%{?scl_prefix}`basename $orig`"
#    mv $orig $new
#done
...
#%{_libdir}/pkgconfig/%{?scl_prefix}libunwind*.pc
%{_mandir}/*/*
...
%changelog
* Wed Mar 18 2015 Marek Skalicky <mskalick@redhat.com> - 1.1-5
